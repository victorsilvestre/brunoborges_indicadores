...
> ⚠️ **Sincronização obrigatória:** este arquivo (`CLAUDE.md`) e [`AGENTS.md`](AGENTS.md) devem ter **sempre o mesmo conteúdo**. Qualquer alteração feita em um dos dois deve ser replicada imediatamente no outro, no mesmo commit.
